 ...
 *
 */
public class pusherRotateUp extends Command {
    ...
    protected void execute() {
    	Robot.pusher.articulateUp(Constants.pusherMotorSpeed);
    }

    // Make this return true when this Command no longer needs to run execute()
    protected boolean isFinished() {
        return Robot.pusher.potValue() > Constants.pusherPotUpVal;
    }
