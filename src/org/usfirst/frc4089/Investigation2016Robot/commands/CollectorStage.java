 ...
 *
 */
public class CollectorStage extends Command {
    ...
    protected void execute() {
    	//runs the motor to attract the collector until the in limit switch is triggered
    ...
    protected boolean isFinished() {
        return Robot.collector.getCollectorStage();
    }
