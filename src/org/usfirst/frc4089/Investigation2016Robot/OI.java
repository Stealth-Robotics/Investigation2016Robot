...
public class OI {
    ...
    public OI() {
        ...
        shifter.whenPressed(new shiftHigh());
        ...
        SmartDashboard.putData("RotateDrive: 45posdeg", new RotateDrive(45));
        SmartDashboard.putData("RotateDrive: 30posdeg", new RotateDrive(30));
        SmartDashboard.putData("RotateDrive: 15posdeg", new RotateDrive(15));
        SmartDashboard.putData("RotateDrive: 5posdeg", new RotateDrive(5));
        SmartDashboard.putData("RotateDrive: 45negdeg", new RotateDrive(-45));
        SmartDashboard.putData("RotateDrive: 30negdeg", new RotateDrive(-30));
        SmartDashboard.putData("RotateDrive: 15negdeg", new RotateDrive(-15));
        SmartDashboard.putData("RotateDrive: 5negdeg", new RotateDrive(-5));
        ...
        SmartDashboard.putData("pusherRotateDown", new pusherRotateDown());
        SmartDashboard.putData("pusherRotateUp", new pusherRotateUp());
