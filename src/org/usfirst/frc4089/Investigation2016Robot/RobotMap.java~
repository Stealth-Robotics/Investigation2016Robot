...
public class RobotMap {
    ...
    public static void init() {
        ...
        sensorsmaxSonar = new AnalogInput(1);
        ...
        airSpike1 = new Relay(0);
        LiveWindow.addActuator("Air", "Spike 1", airSpike1);
        
        airPressureSwitch = new DigitalInput(7);
